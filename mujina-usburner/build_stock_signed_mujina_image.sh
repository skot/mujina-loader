...
STOCK_IMAGE="${STOCK_IMAGE:-${ROOT_DIR}/stock_fw_restore/images/aml_upgrade_package_enc.img}"
PACKER="${PACKER:-${ROOT_DIR}/stock_fw_restore/tools/macos/aml_image_v2_packer}"
PAYLOAD_DIR="${PAYLOAD_DIR:-${ROOT_DIR}/mujina_loader/payload-stockboot-compat}"
...
OUTPUT_IMAGE="${OUTPUT_IMAGE:-${OUTPUT_DIR}/aml_upgrade_package_mujina_stock_signed.img}"
